<template>
    <div class="search">
        <div class="otherContent">
            ...
            <div class="search-btns" style="font-size:14px;line-height:34px">
                ...
                <el-button type="info" size="mini" icon="el-icon-close" @click="init">清空筛选</el-button>
                <el-button type="primary" size="mini" icon="el-icon-search" @click="search">查询</el-button>
            </div>
        </div>
        <transition name="el-zoom-in-top">
            <div class="content" v-if="isShow">
                <el-form :inline="true"  ref="form" :model="data" label-width="110px" v-for="ary in config">
                    <el-form-item style="height:46px;" :label="item.label" size="mini" v-for="(item,index) in ary">
                        ...
                        <el-input :disabled="item.disabled" v-model="data[item.field]" v-if="item.type=='input'"></el-input>
