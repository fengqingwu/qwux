      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="产品信息" prop="producInfo">
            <el-select v-model="ruleForm.producInfo" placeholder="请选择" :disabled="isAmount" filterable @change="change">
        ...
        <el-col :span="8">
          <el-form-item label="盘头组编码" prop="midProdNo" >
            <el-input type="text" v-model.trim="ruleForm.midProdNo" :disabled="isAmount" maxlength="10"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="所属工艺" prop="crafworkStructId">
            <el-select v-model="ruleForm.crafworkStructId" placeholder="请选择"  :disabled="isAmount" filterable >
        ...
        <el-col :span="8">
          <el-form-item label="数量" prop="amount">
            <el-input-number type="number" :disabled="isAmount" v-model.trim="ruleForm.amount" :min="0"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="8">
